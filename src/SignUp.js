...
const SignUp = () => {
    ...
    useEffect(() => {
        setIsDisabled(!(emailValue && passwordValue && nameValue && phoneNumberValue))
      });
    ...
    return ( 
        <div className="auth">
            ...
            <div className="auth-body body">
                <div className='auth-headers sign-up-headers'>
                    <h1>SIGN UP</h1>
                    <p className="gray">Create an account to be able to create a roommate request</p>
                    ...
                    <div className="desktop-only-additionals additionals">
                        ...
                        <span>
                        Already have an account? <Link to='/login'><span className="auth-link">Login</span></Link>
                        </span>
                    </div>         
                </div>
                ...
                <div className='auth-form-fields'>
                    <form action="#">
                        <div>
                            <label>Name</label>
                            <input name="name" type="text" onChange={ (e) => handleNameChange(e.target.value) } required/>
                        </div>
                        <div>
                            <label>Phone Number</label>
                            <input name="phone_number" type="text" onChange={ (e) => handlePhoneNumberChange(e.target.value) } required/>
                        </div>
                        <div>
                            <label>Email</label>
                        ...
                        <button disabled={isDisabled} link='/sign-up'>Next</button>
                    </form>
