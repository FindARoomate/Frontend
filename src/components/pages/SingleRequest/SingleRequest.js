            ...
            <SingleConnectionReceivedTemplate>
                ...
                <div className={styles.topBar}>
                    ...
                    <div className={styles.editIcon}>
                        {!isCurrentlyEditting &&  <Button handleOnClick={() => setIsCurrentlyEditting(true)}><Img src={editIcon}/><span>Edit</span></Button>}
            ...
            {isCurrentlyEditting &&
                ...
                {formik => (
                    ...
                    <form className={styles.formGroupForm} onSubmit={(e) => updateRoommateRequest(e, formik.errors)} >
                        ...
                        <Button customStyle={{float: "right"}} className={isLoading ? "isLoading" : ""} type="submit">{isLoading ? "Loading..." : "Update"} </Button>
                    </form>
                    )}
                </Formik>
                }
